...
export default async function BestSellers() {
  ...
  const { items } = await apiClient.get<PaginatedResult<Book>>("/books?limit=6");
      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-10">
          <div>
            ...
            <h2 className="text-3xl md:text-4xl font-heading font-bold not-italic text-ink">Best Sellers</h2>
          </div>
          <Link
            href="/shop"
